...
class ReduceResourceClutter(Toggle):
    """Rather than receiving N of a resource for the number of times it's been received,
    instead just receive 1 of a resource whenever it's received. Useful for longer asyncs
